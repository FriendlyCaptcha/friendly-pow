...
This contains the core algorithms used in FriendyCaptcha, if you are looking for the client code (=widget) and documentation, see the [**friendly-challenge** repository](https://github.com/gzuidhof/friendly-challenge).
